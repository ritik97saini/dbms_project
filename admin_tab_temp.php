...
<html>
	...
	<body>
        ...
        <div id = "baap" style="position:fixed;width:100%;">
                        ...
                        <div id="disp_info" style="display:none;">
                                ...
                                <table class = "grp_table">
                                      ...
                                      <tr class = "grp_tr">
                                        ...
                                        <td class = "grp_td">'.$row['grp_name'].'</td>
                                      </tr>
                                      <tr class = "grp_tr">
                                        <td class = "grp_td">Group Code</td>
                                        <td class = "grp_td">'.$row['group_id'].'</td>
                                      </tr>
                                      <tr class = "grp_tr">
                                        <td class = "grp_td">Description</td>
                                        <td class = "grp_td">'.$row['description'].'</td>
                                      </tr>
                                      <tr class = "grp_tr">
                                        <td class = "grp_td">Created On</td>
                                        <td class = "grp_td">'.$row['created_on'].'</td>
                                      </tr>
                    ...
                    <div id="notice" style="margin-top:80px; ">
                        ...
                        <?php
							...
							while ($row1=mysqli_fetch_assoc($query1)) {
                                ...
                                border-radius: 20px;
                                ">
							<center><p style="font-size: 40px; color:white;">                              
                                <?php echo $row2['heading']; ?>
                                </p></center>
                            <center><p style="font-size: 15px;color:white;">
                       ...
                       Description:       <?php echo $row2['description']; ?>
							...
							<center style="font-size: 40px; color:white;">                              
                                <?php echo $row2['heading']; ?>
                                        ...
                                        <center style="position:relative;top:-35px;"><table>
                            <tr style="font-size: 15px; color:white;">
                                
                                <td>Description&nbsp;:&nbsp;&nbsp;</td>   <td><?php echo $row2['description']; ?></td>
                                </tr>
                                <br>
                           <tr style="font-size: 15px;color:white;">
                                
                               <td>Job Type&nbsp;:&nbsp;&nbsp; </td>  <td><?php echo $row2['job_type']; ?></td>
                               </tr>
                                <br>        
                                 
                                 <tr style="font-size: 15px; color:white;">
                                
                                     <td>CTC&nbsp;:&nbsp;&nbsp;</td>    <td><?php echo $row2['ctc']; ?></td>
                                     </tr>
                                <br>              <tr style="font-size: 15px;color:white;">
                                
                                <td>Aggregate&nbsp;:&nbsp;&nbsp;</td>   <td> <?php echo $row2['aggregate']; ?> </td>
                                </tr>
                                <br>             
                        
                                <tr style="font-size: 15px; color:white;">
                                
                                    <td>Deadline&nbsp;:&nbsp;&nbsp;</td>  <td><?php echo $row2['deadline']; ?></td>
                                    </tr></table></center>
                                        <br>    
                                
                                <center>    <div style="font-size: 25px;color:white;">Branches Allowed:</div>                   <?php                         
